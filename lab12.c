...
char* encodeCaesar(char* src, char* dest)
{
    ...
    for (; *src; ++src, ++dest)
    {
        ...
        else if (isupper(*src))
        {
            ...
            offset = *src - 'A';
            *dest = toupper(lcEncodingKey[offset]);
        }
...
char* encodeSubstitution(char* lcEncodingKey, char* src, char* dest)
{
    ...
    for (i = 0; i < 26; i++)
    {
        ucEncodingKey[i] = lcEncodingKey[i];
    }
    ...
    for (; *src; ++src, ++dest)
    {
        ...
        else if (isupper(*src))
        {
            ...
            offset = *src - 'A';
            *dest = toupper(ucEncodingKey[offset]);
...
char* decodeSubstitution(char* lcEncodingKey, char* src, char* dest)
{
    ...
    for (i = 0; i < 26; i++)
    {
        ...
        lcDecodingKey[offset] = 'a' + i;
        ucDecodingKey[offset] = lcDecodingKey[offset];
    ...
    for (; *src; ++src, ++dest)
    {
        ...
        else if (isupper(*src))
        {
            ...
            offset = *src - 'A';
            *dest = toupper(ucDecodingKey[offset]);
